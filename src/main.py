...
# TF-IDF feature engineering and similarity matrix
...
# Vectorize based on teams recent transfer players for "freshness"
...
# Alpha-weighted hybrid similarity: mix current squad with recent transfers 
alpha = 0.3
